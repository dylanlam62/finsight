"""force_ask_human_multifields

Revision ID: 0009
Revises: 0008
Create Date: 2026-05-15 03:10:00.000000
...
When asking for MULTIPLE missing info (like the 5 fields), you MUST use the `multi_fields` parameter of the `ask_human` tool so the UI renders a nice tabbed dialog for the user. 
Example of using `multi_fields`:
[
  {"id": "name", "label": "Project Name"},
  {"id": "type", "label": "Project Type", "options": ["residential", "commercial office", "retail", "mixed-use", "hotel", "industrial", "other"]},
  {"id": "sponsor", "label": "Sponsor/Company"},
  {"id": "capex", "label": "CAPEX (HKD Millions)"},
...
2. Check the input. If required fields are missing, call `ask_human` immediately with `multi_fields` populated to ask for all missing pieces at once.
